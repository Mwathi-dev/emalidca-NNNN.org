							...
							<ul>
								...
								<li>
									...
									<li>
										...
										<li>
											<a class="email" href="<?php getlinks("links","email");?>">
												<i class="fab fa-email"></i>

												<span class="count"></span>info@emalidca@org </a>
											</li>
											<li>
												<a class="pin" href="<?php getlinks("links","call");?>">
													<i class="fab fa-call"></i>
													<span class="count"></span> +254 746837197</a>
												</li>
